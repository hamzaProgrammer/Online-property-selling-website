        ...
        <Grid container spacing={2} className={classes.head} >
            ...
            <Grid item xs={11} sm={10} md={4}>
                <Box className={classes.box}>
                    ...
                    <Typography className={classes.text}>Register Now</Typography>
                    {
                        isSuccess  === true && (
                            <Alert
                                message="Sign Up SuccessFull"
                                ...
                                showIcon
                                closable
                                style={{minWidth : '100%' , marginBottom : '15px' , marginTop: '10px'}}
                            />
                        )
                    }
                    {
                    ...
                    <Link to="/signin" style={{textDecoration : 'none'}} >
                        <Typography className={classes.signin}>Already have an Account? Sign In Now</Typography>
                    </Link>
                </Box>
            </Grid>
            <Grid item xs={0.5} sm={1} md={4}>
