...
import {sendMail} from '../../../server_api/Api'
...
const ForgetPassword = () => {
    ...
    const SendEmail = async () => {
        ...
        if(myEmail=== "" ){
            ...
            const {data} = await sendMail(myEmail);
            console.log("mail sent data :", data)
            if(data?.success === true){
                setSuccess(true);
                localStorage.setItem("userEmail", JSON.stringify(myEmail));
                setMsg(data?.message);
        ...
        <Row>
            <Col xs={24} sm={24} md={14} lg={12} className="signupmaindiv" >
                ...
                <div className="signUpCompDiv" >
                    ...
                    >
                        <Input className="formItemSignUp" placeholder="jhone@gmail.com" onChange={(e) => setMyEmail(e.target.value)} />
                    </Form.Item>
