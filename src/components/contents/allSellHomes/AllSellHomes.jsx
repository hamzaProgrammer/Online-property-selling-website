...
import {getAllSellPropertiesOfCity , getAllSellPropertiesOfCityByUsers , addNewSavedLater ,  getPropertiesByCity, getAllSellPropertiesOfCityByAdmin , addNewSavedSearch } from '../../../server_api/Api'
        ...
        <>
            ...
            <Row style={{marginTop : '20px'}} >
                    <Col xs={24} sm={24} md={{span : 22 , offset : 1}} lg={{span : 12 , offset : 0}} xl={{span: 12, offset : 1}} style={{marginBottom : '15px'}} >
                        <Spin spinning={isSpinning} >
                            <Typography className="propertyLeftSideHead" >All Properties Available For Sell in {myCity.charAt(0).toUpperCase() + myCity.slice(1)} are </Typography>
                            {
